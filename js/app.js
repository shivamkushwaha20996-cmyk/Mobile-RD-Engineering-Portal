...
function applyPrefs(){document.body.classList.toggle("no-motion",!prefs.motion);document.body.dataset.theme=prefs.theme;document.body.dataset.accent=prefs.accent;document.body.dataset.density=prefs.density;const accentMap={cyan:["#0891b2","#ecfeff","#a5f3fc"],blue:["#2563eb","#eff6ff","#bfdbfe"],violet:["#7c3aed","#f5f3ff","#ddd6fe"],emerald:["#059669","#ecfdf5","#a7f3d0"],amber:["#d97706","#fffbeb","#fde68a"],rose:["#e11d48","#fff1f2","#fecdd3"],orange:["#ea580c","#fff7ed","#fed7aa"],indigo:["#4f46e5","#eef2ff","#c7d2fe"],teal:["#0d9488","#f0fdfa","#99f6e4"],fuchsia:["#c026d3","#fdf4ff","#f5d0fe"],sky:["#0284c7","#f0f9ff","#bae6fd"]};const a=accentMap[prefs.accent]||accentMap.cyan;document.documentElement.style.setProperty("--accent",a[0]);document.documentElement.style.setProperty("--accent-soft",a[1]);document.documentElement.style.setProperty("--accent-border",a[2]);document.body.style.setProperty("--accent",a[0]);document.body.style.setProperty("--accent-soft",a[1]);document.body.style.setProperty("--accent-border",a[2]);document.getElementById("themeSelect").value=prefs.theme;document.getElementById("accentSelect").value=prefs.accent;document.getElementById("densitySelect").value=prefs.density;document.getElementById("motionToggle").checked=prefs.motion;document.getElementById("themeIcon").className=`fa-solid fa-${prefs.theme==="dark"?"sun":"moon"}`}
